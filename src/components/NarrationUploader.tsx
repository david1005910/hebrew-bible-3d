  ...
  return (
    <div style={panelStyle}>
      ...
      <div style={headerStyle}>
        <span style={{ fontWeight: 700, fontSize: 15 }}>🎙 나레이션</span>
      ...
      <div style={sectionStyle}>
        ...
        <button
          ...
          style={{
            ...btnBase,
            width: '100%',
            background: uploading ? '#555' : 'rgba(240,160,60,0.9)',
      ...
      {fileName && (
        <div style={sectionStyle}>
          ...
          <input
            ...
            style={{ width: '100%', accentColor: 'rgba(240,160,60,0.9)' }}
          />
        </div>
      )}
    </div>
...
const toggleBtnStyle: React.CSSProperties = {
  padding: '10px 18px',
  borderRadius: 8,
  border: '2px solid rgba(240,160,60,0.6)',
  background: 'rgba(240,160,60,0.9)',
  color: '#000',
  fontSize: 14,
  fontWeight: 700,
  cursor: 'pointer',
